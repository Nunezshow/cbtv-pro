...
--- a/ui/home/ChannelGridFragment.kt
...
-    private val viewModel: ChannelGridViewModel by viewModels()
...
-        adapter = ChannelGridAdapter(emptyList()) { channel ->
-            // TODO: Handle channel click (e.g., open player)
-        }
...
-        // Optional: Trigger loading or observe filters here
